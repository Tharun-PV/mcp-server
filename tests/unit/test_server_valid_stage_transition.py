...
async def test_handle_call_tool_valid_stage_transition_success(monkeypatch):
    ...
    def mock_make_devrev_request(endpoint, payload):
        if endpoint == "works.get":
            return type("Resp", (), {"status_code": 200, "json": lambda self: {"work": {"stage": {"stage": {"id": "stage_1"}}, "type": "issue", "subtype": "subtype_1"}}})()
        elif endpoint == "schemas.aggregated.get":
            return type("Resp", (), {"status_code": 200, "json": lambda self: {"schema": {"stage_diagram_id": {"id": "diagram_1"}}}})()
        elif endpoint == "stage-diagrams.get":
            return type("Resp", (), {"status_code": 200, "json": lambda self: {"stage_diagram": {"stages": [{"stage": {"id": "stage_1"}, "transitions": ["to_stage_2"]}]}}})()
        return type("Resp", (), {"status_code": 404, "json": lambda self: {}})()
